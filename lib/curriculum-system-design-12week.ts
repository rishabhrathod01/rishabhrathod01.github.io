...
export const SYSTEM_DESIGN_12WEEK: CurriculumWeek[] = [
  {
    ...
    items: [
      ...
      {
        label: "Video: How Discord Stores TRILLIONS of Messages",
        href: "https://www.youtube.com/watch?v=xDC71DKtDUE",
      },
      {
        label:
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Video: Big-O Notation in 100 Seconds (Fireship)",
        href: "https://www.youtube.com/watch?v=g2o22C3CRfU",
      },
      {
        label:
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Video: System Design Interview Basics (ByteByteGo)",
        href: "https://www.youtube.com/watch?v=FSR1s2b-l_I",
      },
      {
        label:
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Video: Rate Limiting (Fireship)",
        href: "https://www.youtube.com/watch?v=cIperSdIEpI",
      },
      {
        label:
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Video: Consistent Hashing (Gaurav Sen)",
        href: "https://www.youtube.com/watch?v=zaRkONvyGr8",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Video: Database Sharding Explained (Fireship)",
        href: "https://www.youtube.com/watch?v=5faMjKuB9bc",
      },
      {
        label:
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Video: UUID vs. Snowflake IDs",
        href: "https://www.youtube.com/watch?v=gpxnbly9bz4",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Video: How Bitly Works (Systems Design)",
        href: "https://www.youtube.com/watch?v=fMZMm_0ZhK4",
      },
      {
        label:
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Video: How Search Engines Crawl the Web",
        href: "https://www.youtube.com/watch?v=BKorP55Aqvg",
      },
      {
        label:
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Video: Push Notifications at Scale (Netflix)",
        href: "https://www.youtube.com/watch?v=6w6E_B55p0E",
      },
      {
        label:
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Video: How Instagram's Feed Works",
        href: "https://www.youtube.com/watch?v=QmX2NPkJTKg",
      },
      {
        label:
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Video: WhatsApp System Design",
